...
initial_omegas = omega_magnitude * np.deg2rad( np.ones(3) )
...
perturbed_omega = initial_omegas + perturbation

# print(f"Inital Omega (shape = {initial_omegas.shape}) is \n{initial_omegas} rad/s.")
# print(f"Perturbation (shape = {perturbation.shape}) is {perturbation} rad/s.")
# print(f"Perturbed Omega (shape = {perturbed_omega.shape}) is \n{perturbed_omega} rad/s.")
...
# Save the figures.
fig1.savefig(file_path + "Angle.png")
fig2.savefig(file_path + "Omega.png")
fig3.savefig(file_path + "Conserved.png")
